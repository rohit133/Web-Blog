...
app.get("/about", function(req, res){
  res.render("about",{aboutContentintro: aboutContent});
});

// Conctact
app.get("/contact", function(req, res){
  res.render("contact",{contactContentintro: contactContent});
});

// Compose
app.get("/compose", function(req, res){
  res.render("compose",{contactContentintro: contactContent});
});
